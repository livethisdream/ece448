  \begin{tikzpicture}
      ...
      \draw[thick] (O)--(D);
      \draw[thick, dashed] (A1)--(P) node[right, yshift=-1mm] {\small $P$};
      \draw[thick] (D)--(P);
      \fill[black] (P) circle (3pt);


      \coordinate (A) at (2.6, 4.0);
      \draw[thick, dashed] (A1)--(A) node[right, yshift=-1mm, xshift=-1mm] {\small $A$};
      ...
      \node[right, label={[xshift=0.05cm, yshift=-0.25cm]\small $C$}] at (C) {};
      ...
      % differential labels
      \node[right, yshift=1mm,xshift=2mm, rotate=-20,pin={[pin distance=1cm]-20:{$\rho d \phi$}}] at (Q) {};
      \node[right, yshift=6mm, xshift=-1mm,pin={[pin distance=1cm]0:{$dz$}} ] at (B) {};
